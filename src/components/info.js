...
const Info = (searchResults = []) => (
  <aside>
    <h2>What's this?</h2>
    <p>
      The <a href='https://twitter.com/GDSteam'>GDS agile delivery community</a> added hundreds of links about agile, lean and people to a now defunct "Linkydink". You can browse most of those links here.
    </p>
    <p>
